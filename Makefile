...
set-repo:
	...
	sed -i.bak 's|YOUR_GITHUB_USER|$(OWNER)|g; s|haotian-lu-prog|$(OWNER)|g' README.md README.zh-CN.md CHANGELOG.md CONTRIBUTING.md SECURITY.md dsh-update-all.sh install.sh Formula/dsh-update-all.rb plugin/package.json plugin/README.md plugin/README.zh-CN.md .github/ISSUE_TEMPLATE/config.yml .github/workflows/release.yml .github/workflows/upstream-check.yml
	rm -f README.md.bak README.zh-CN.md.bak CHANGELOG.md.bak CONTRIBUTING.md.bak SECURITY.md.bak dsh-update-all.sh.bak install.sh.bak Formula/dsh-update-all.rb.bak plugin/package.json.bak plugin/README.md.bak plugin/README.zh-CN.md.bak .github/ISSUE_TEMPLATE/config.yml.bak .github/workflows/release.yml.bak .github/workflows/upstream-check.yml.bak
